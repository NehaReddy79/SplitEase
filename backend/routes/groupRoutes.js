...
const {createGroup , addMember , getMyGroups , getGroupMembers , leaveGroup} = require('../controllers/groupController')
...
router.delete('/:groupId/leave' , verifyToken , verifyUser , leaveGroup)
